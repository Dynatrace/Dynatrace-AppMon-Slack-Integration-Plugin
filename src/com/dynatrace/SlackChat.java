	...
	public Status execute(ActionEnvironment env) throws Exception {
		...
		*/
		...
		for (Incident incident : incidents) {
            ...
            String strTags = env.getConfigString("tags");
...
//                      chat_message = chat_message + "<li><strong>Status state code:</strong> " + incident.getState() + "</li>";
                        ...
                        /*
                         * If set, tag individual users.
                         * Format is
                         * "<@username><@username2>..."
                         */
                        if (strTags != null && !strTags.isEmpty())
                        {
                        	List<String> oTagList = getUserTagList(strTags);
                        ...
                        //chat_message += "<@mitchpearson> <@adamgardner-dt>";
                        //chat_message = chat_message + "</ul>";
...
//			}
	...
	private static List<String> getUserTagList(String strTags)
	{
		List<String> oList = new ArrayList<String>();

		String[] astrTags = strTags.split(" ");
		
		for (int iCount = 0; iCount < astrTags.length; iCount++)
		{
			oList.add(astrTags[iCount]);
		}
